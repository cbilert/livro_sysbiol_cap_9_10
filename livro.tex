...
\begin{center}
    \vspace*{2.3cm}
    \textbf{\Large{Primeiros passos a biologia de sistemas}}\\
    
    \vspace*{1.2cm}
    \Large{Nome completo do Autores}
...
\input cap-grns              % associado ao arquivo: 'cap-grns.tex' -> Redes de Regulação Gênica -> Denilson
